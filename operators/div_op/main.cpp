...
int32_t main(int32_t argc, char *argv[])
{
    ...
    const char* kernelPath = "./div_custom_kernel.o";
    ...
    ret = aclrtBinaryGetFunction(binHandle, "div_custom", &funcHandle);
    if (ret != ACL_SUCCESS) {
    ...
    printf("Args size: %zu, x=%p, y=%p, z=%p, len=%u\n", 
           sizeof(args), (void*)args.x, (void*)args.y, (void*)args.z, args.totalLength);
    ...
    printf("Div operator executed successfully!\n");
    printf("Input x[0:3]: %.4f, %.4f, %.4f, %.4f\n",
           ((float*)xHost)[0], ((float*)xHost)[1], ((float*)xHost)[2], ((float*)xHost)[3]);
    printf("Input y[0:3]: %.4f, %.4f, %.4f, %.4f\n",
           ((float*)yHost)[0], ((float*)yHost)[1], ((float*)yHost)[2], ((float*)yHost)[3]);
    printf("Output z[0:3]: %.4f, %.4f, %.4f, %.4f\n",
